    ...
    <div class="main">
      <el-form ref="form" :label-position="'top'" :model="form" label-width="80px">
        <div class="info">
          <el-form-item label="产品备案号" prop="recordnum">
            <el-input
              ...
              :disabled="list.isrecord == 2||disabled?true:false"
              @blur="validatePass"
            ></el-input>
          </el-form-item>
          <el-form-item
          ...
          <el-form-item
            label="规格"
            prop="specname"
            :rules="[{ required: true, message: '请输入产品规格', trigger: 'blur' }]"
          >
        ...
        <el-form-item
          label="产品详情"
          prop="content"
          :rules="[{ required: true, message: '请输入产品详情', trigger: 'blur' }]"
        >
        ...
        <el-form-item>
          <el-button
            ...
            v-if="datas"
          >{{list.isrecord == 1?'保存':'提交'}}</el-button>
